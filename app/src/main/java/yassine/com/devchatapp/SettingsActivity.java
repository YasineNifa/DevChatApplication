...
public class SettingsActivity extends AppCompatActivity {
    ...
    private StorageReference mStorageProfileImageRef;

    private TextView settingsDisplayName;
    private TextView settingsDisplayStatus;
    private Button settingsChangeProfilImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageProfileImageRef = FirebaseStorage.getInstance().getReference().child("Profile_images");
        ...
        settingsDisplayName = (TextView)findViewById(R.id.setting_user_name);
        settingsDisplayStatus = (TextView)findViewById(R.id.setting_user_status);
        settingsChangeStatus = (Button)findViewById(R.id.setting_change_status);
        settingsChangeProfilImage = (Button)findViewById(R.id.setting_change_profile_image);
        ...
        getUserDataReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //Picasso.get().load(image).into(settingsDisplayImage);
                if(!image.equals("default_profile")){
                    Picasso.get().load(image).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.default_profile).into(settingsDisplayImage, new Callback() {
                        @Override
        ...
        settingsChangeProfilImage.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE){
            ...
            if(resultCode==RESULT_OK){
                ...
                StorageReference filePath = mStorageProfileImageRef.child(user_id + ".jpg");
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull final Task<UploadTask.TaskSnapshot> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(SettingsActivity.this,"Error occured while uploading your profile image",Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
                        }
                    }
                });
